...
class addSubjectList_AA_UI extends StatefulWidget {
  //
  addSubjectList_AA_UI() : super();

  final String title = 'Flutter Data Table';

  @override
  addSubjectList_AA_UIState createState() => addSubjectList_AA_UIState();
}
...
class addSubjectList_AA_UIState extends State<addSubjectList_AA_UI> {
  ...
  TextEditingController subjectDay = TextEditingController();
  ...
  addSubject() async{
    ...
    String query = "INSERT INTO `subjectlist` (`subjectID`, `subjectName`, `subjectCourseCode`, `subjectCourseType`, `subjectDay`, `subjectStartTime`, `subjectEndTime`, `subjectDay_1`, `subjectStartTime_1`, `subjectEndTime_1`, `subjectLecturer`, `subjectSectionNumber`, `subjectCreditHours`, `maxStudents`, `currentStudents`, `semester`) VALUES "
        ...
        "'"+ subjectDay.text +"', "
        "'"+ subjectStartTime.text +"', "
        "'"+ subjectEndTime.text +"', "
        "'"+ subjectDay_1.text +"', "
        "'"+ subjectStartTime_1.text +"', "
        "'"+ subjectEndTime_1.text +"', "
        "'"+ subjectLecturer.text +"', "
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: MaterialButton(
                        onPressed: () =>
                        _formAddKey.currentState!.validate()
                            ? validateTime()
                            : null,
                        child: const Text(
                          'Add Subject',
